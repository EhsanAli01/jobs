...
const Notifications = () => {
  ...
  if (notifications.length === 0)
    return (
      <div className="flex justify-center text-4xl text-gray-500 gap-3 items-center flex-col w-full h-[500px]">
        <span>
          <FcEmptyTrash />
        </span>
        No notifications
  ...
  return (
    <section className="mx-24">
      <div className="flex justify-between items-center pt-10 pb-3">
        <h1 className="font-bold text-3xl text-gray-600 font-sans tracking-tight">
          Notifications:
        </h1>
        <button
      ...
      <div className="my-2 text-justify flex flex-col gap-2 py-2">
