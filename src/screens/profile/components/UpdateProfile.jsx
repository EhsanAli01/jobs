    ...
    <Fragment>
      ...
      >
        <form
          ...
          className="flex justify-center items-center w-[400px] flex-col px-4 py-2 gap-3"
        >
          ...
          <h1 className="font-semibold text-xl font-sans">Update Profile</h1>
          ...
          <div className="w-full flex items-center justify-center">
            <div className="flex justify-between items-center ">
              <label
                htmlFor="fileUpload"
                className="border border-gray-600 cursor-pointer w-20 rounded-full flex justify-center items-center flex-col h-20 my-1 bg-gray-100 overflow-hidden"
              >
                {imageUrl ? (
                  <img
                    src={imageUrl}
