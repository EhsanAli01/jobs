  ...
  return (
    <section className="py-10 flex justify-center items-center">
      <form
        ...
        className="rounded-sm border border-gray-500 w-[380px] flex justify-center items-center flex-col px-5 py-6 gap-3"
      >
        <h1 className="pb-1 font-semibold text-lg">Create Job</h1>
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-3 items-center">
            <label
              htmlFor="fileUpload"
              className="border border-dashed border-gray-500 w-[105px] rounded-md flex justify-center items-center flex-col h-36 my-1 bg-gray-100"
            >
              <MdOutlineCloudUpload className="text-xl text-gray-600" />
            ...
            {imageTempUrls?.map((url, index) => (
              <div
                key={url}
                className="border relative border-slate-500 w-[105px] h-36 rounded-lg overflow-hidden"
              >
                <img
                  key={url}
                  src={url}
